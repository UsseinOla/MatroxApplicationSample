        ...
        private static async Task ExecuteRequestAsync(UserRequest request)
        {
            ...
            if (additionSucceeded)
            {
                 ...
                 if ((unit.Urn == UnitURN.SV2Dec) && (unit.Capabilities == UnitCapabilities.CanDecode))
                {
                    ...
                    /// access Rs232
                    var rs232 = new SV2.Types.Decoder.SettingsDetails.Rs232Settings();
                    rs232.Mode = SV2.Types.Decoder.SettingsDetails.Types.RS232Mode.Tcp;
                    rs232.TcpPort = 123;
                    rs232.BaudRate = SV2.Types.RS232BaudRate.Baud1200;
                    rs232.DataBits = SV2.Types.RS232DataBits.Use6;
                    rs232.Parity = SV2.Types.RS232ParityCheck.UseEven;
                    rs232.StopBits = SV2.Types.RS232StopBits.Use2;
                    rs232.FlowControl = SV2.Types.RS232FlowControl.UseRtsCts;
                    /// asing the created object to the settings
                    settings.Rs232 = rs232;
