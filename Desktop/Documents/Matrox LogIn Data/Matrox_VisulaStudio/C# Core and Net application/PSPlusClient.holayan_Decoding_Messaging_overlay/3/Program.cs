        ...
        private static async Task ExecuteRequestAsync(UserRequest request)
        {
            ...
            if (additionSucceeded)
            {
                ...
                if ((unit.Urn == UnitURN.SV2Dec) && (unit.Capabilities == UnitCapabilities.CanDecode))
                {
                    ...
                    text.Settings.TextLine = "Hello, Matrox!";

                    // make the Text color to yellow(255,255,0)
                    text.Settings.TextColor.Alpha = 255;
                    text.Settings.TextColor.Red = 0;
                    text.Settings.TextColor.Green = 0;
                    text.Settings.TextColor.Blue = 0;

                    //put Scrolling speed to 5
                    text.Settings.ScrollingSpeed = 5;

                    // give the textline Rectangle it's dimmenssion 
                    // each resolution has it's own font size details
                    // back ground Rectangle
                    text.Settings.BackgroundRect.Bottom = 240;
                    text.Settings.BackgroundRect.Left = 0;
                    text.Settings.BackgroundRect.Right = 3840;
                    text.Settings.BackgroundRect.Top = 0;

                    // text Rectangle
                    text.Settings.TextRect.Bottom = 216;
                    text.Settings.TextRect.Left = 0;
                    text.Settings.TextRect.Right = 3840;
                    text.Settings.TextRect.Top = 24;
                    ...
                    /// Note: take a look to TestFunctionalDecoderVideoStreamSourceAsync
